            ...
            {users.map((user) => (
              <TableRow key={user.id}>
                ...
                <TableCell className={`text-center `}>
                  {user.role === "TRAINER" ? (
                    <span className="bg-accent-foreground px-2 py-1 rounded-md w-fit text-black">
                      مدرب
                    </span>
                  ) : (
                    <span className="bg-green-600 px-2 py-1 rounded-md w-fit text-black">
                      مدير
                    </span>
                  )}
                </TableCell>
